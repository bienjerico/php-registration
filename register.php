...
if(isset($_POST['btn-submit'])){
    ...
    $result = $controller->register_validate($array);
//    print_r($result);
    //echo $result['message'];
        ...
        <form method='post' id='form-register'  name='form-register' action='<?php echo $_SERVER['PHP_SELF']; ?>'>
            <table class="table table-hover">
                ...
                <tbody>
                    <tr>
                        <td>Username:</td>
                        <td><input type='text'   class="form-control"  id='username' name='username' value='<?php echo $r_username; ?>'/><span class='text-danger'>Required</span></td>
                    </tr>
                    <tr>
                        <td>Password:</td>
                        <td><input type='password'  class="form-control" id='password' name='password' value=''/><span class='text-danger'>Required</span></td>
                    </tr>
                    <tr>
                        <td>Confirm Password:</td>
                        <td><input type='password'   class="form-control" id='conpassword' name='conpassword' value=''/><span class='text-danger'>Required</span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan='2' class='text-center'><button type='submit'  class="btn btn-lg btn-primary" id='btn-submit' name='btn-submit'>Submit</button>
                            <a href='login.php'><button type='button' class="btn btn-lg btn-warning" id='btn-backtologin' name='btn-backtologin'>Back to Login</button></a></td>
                    </tr>
                </tbody>
            </table>
        </form>
